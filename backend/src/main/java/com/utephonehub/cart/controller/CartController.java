package com.utephonehub.cart.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.utephonehub.cart.dto.*;
import com.utephonehub.cart.service.CartService;
...
public class CartController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            com.utephonehub.cart.dto.CartDTO cart = cartService.getCart(userId);
...
//            req.getRequestDispatcher("/WEB-INF/views/cart.jsp").forward(req, resp);
    ...
    protected void doPut(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        try {
            ...
            com.utephonehub.cart.dto.UpdateCartItemRequest request = mapper.readValue(req.getReader(), com.utephonehub.cart.dto.UpdateCartItemRequest.class);
