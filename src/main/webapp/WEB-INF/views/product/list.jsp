...
<c:set var="pageDescription" value="Khám phá bộ sưu tập sản phẩm công nghệ chính hãng tại UTE Phone Hub" scope="request"/>
<!DOCTYPE html>
<html lang="vi">
<head>
  ...
  <!-- Page-specific CSS -->
  <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/pages/product-list.css">
</head>
<body>
        ...
        <aside class="filter-sidebar">
          ...
          <div class="filter-group">
            ...
            <div class="filter-options">
              <div class="filter-option" data-filter="price" data-min="0" data-max="5000000">
                <input type="checkbox" id="price1">
                <label for="price1">Dưới 5 triệu</label>
              </div>
              <div class="filter-option" data-filter="price" data-min="5000000" data-max="10000000">
                <input type="checkbox" id="price2">
                <label for="price2">5 - 10 triệu</label>
              </div>
              <div class="filter-option" data-filter="price" data-min="10000000" data-max="20000000">
                <input type="checkbox" id="price3">
                <label for="price3">10 - 20 triệu</label>
              </div>
              <div class="filter-option" data-filter="price" data-min="20000000" data-max="999999999">
